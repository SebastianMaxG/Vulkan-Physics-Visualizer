...
namespace lsmf
{
	...
	void FirstApp::LoadModels()
	{
		...
		m_model = std::make_unique<ProjectModel>(m_device, vertices);
	}
	...
	void FirstApp::recreateSwapChain()
	{
		...
		{
			m_swapChain = std::make_unique<ProjectSwapChain>(m_device, extent, std::move(m_swapChain));
	...
	void FirstApp::recordCommandBuffer(int imageIndex)
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			push.offset = { 0.f, -0.4f + static_cast<float>(i) * 0.25f };
